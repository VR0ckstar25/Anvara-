...
INSERT INTO synonyms (parent_id, term, confidence_level, source, cross_note) VALUES
  ...
  ('milk','Cream','HIGH','FARE','Dairy cream; guard plant/non-dairy uses in matcher.'),
  ('milk','Cheese','HIGH','FARE','Dairy cheese; guard vegan/non-dairy uses in matcher.'),
  ('milk','Butter','HIGH','FARE','Dairy butter; guard nut/plant butter uses in matcher.'),
